...
void updateDisplay(){
  ...
  EZ_SetColor(face2color);
  EZ_FillCircle(face2X0, face2Y0, face2radius);
...
int main() {
  ...
  EZ_Init(WINDOWWIDTH, WINDOWHEIGHT, "CLEMSON TIGER");
